...
colornum = 12
colors = [(0,128,128),(128,0,0),(192,192,128),(255,69,0),(128,64,128),(60,40,222),(128,128,0),(192,128,128),(64,64,128),(64,0,128),(64,64,0),(0,128,192),(0,0,0)];
...
def Visualize(img, results):
	...
	if detectedNum > 0:
            for i in range(detectedNum):
                ...
                cv2.putText(img_cp,txt,(left+5,top-7),cv2.FONT_HERSHEY_SIMPLEX,0.3,clr,1)
