...
python3 /opt/intel/openvino/deployment_tools/model_optimizer/mo.py --input_model $caffemodel --data_type FP16 --output_dir /data/github_repos/yolov3-tiny-fit-ncs/ncs2/yolov3-tiny-ssd-ncs-mini-pack/FP16 --scale_value data[255,255,255]
